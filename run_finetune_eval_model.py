...
#         if args.dataset:               
#             args.experiment_name = f"FinetuneModel_model={args.model_id.replace('/','-')}_dataset={args.dataset.replace('/','-').replace('@','-')}_split={args.split}_nsamples={args.num_samples}_num_per_noise={args.num_per_noise}"
#         else:
#             args.experiment_name = f"FinetuneModel_model={args.model_id.replace('/','-')}_dataset=OLD_task={args.task}_split={args.split}_nsamples={args.num_samples}_num_per_noise={args.num_per_noise}"
        
#     args.experiment_dir  = f"results/FinetuneModel/{args.experiment_name}/"
