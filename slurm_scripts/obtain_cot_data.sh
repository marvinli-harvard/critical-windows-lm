...
if [ "$task_id" -eq 0 ]; then
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset competition_math --split train --task math --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset lucasmccabe/logiqa --split train --task logic --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset truthfulqa/truthful_qa --split validation  --task "true or false" --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset cais/mmlu --split auxiliary_train --task "multiple choice" --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset allenai/ai2_arc@ARC-Challenge --split train  --task science --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset allenai/ai2_arc@ARC-Easy --split train --task science --num_samples 400 --num_per_noise 25
    ...
    python run_noisedenoise.py --model_id meta-llama/Llama-3.1-8B-Instruct --dataset deepmind/aqua_rat --split train  --task math --num_samples 400 --num_per_noise 25
else
